...
int main()
{
    char s1[100],s2[100],c,l1,l2,firstposition;
    /*1-Print on screen the correct lengths of both strings*/
    ...
    /*5-find the position of the first occurrence of c within s1*/
    printf("Enter the character:");
    scanf(" %c", &c);
    if(strchr(s1,c)!=0)
    {
        firstposition=strchr(s1,c)-s1+1;
        printf("The first position of the character %c is %d", c, firstposition);
    }
    return 0;
}
